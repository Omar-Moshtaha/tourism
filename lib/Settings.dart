                ...
                child: Row(
                  children: [
                    CircleAvatar(
                        ...
                        child: Image(
                          image: AssetImage("image/image14.png"),
                          color: Colors.white,
                        )),
                    Padding(
                ...
                child: Row(
                  children: [
                    CircleAvatar(
                        backgroundColor: HexColor("#FFD24A"),
                        child: Image(
                          image: AssetImage("image/image37.png"),
                          color: Colors.white,
                        )),
                    Padding(
                      padding: const EdgeInsets.only(left: 15),
                ...
                child: Row(
                  children: [
                    CircleAvatar(
                        backgroundColor: HexColor("#FFD24A"),
                        child: Image(
                          image: AssetImage("image/image41.png"),
                          color: Colors.white,
                        )),
                    Padding(
                      padding: const EdgeInsets.only(left: 15),
                  ...
                  children: [
                    CircleAvatar(
                        ...
                        child: Padding(
                          ...
                          child: Image(
                            image: AssetImage("image/image40.png"),
                            color: Colors.white,
                          ),
                        )),
                    Padding(
                ...
                child: Row(
                  children: [
                    CircleAvatar(
                        backgroundColor: HexColor("#FFD24A"),
                        child: Image(
                          image: AssetImage("image/image39.png"),
                          color: Colors.white,
                        )),
                    Padding(
                      padding: const EdgeInsets.only(left: 15),
                ...
                child: Row(
                  children: [
                    CircleAvatar(
                        backgroundColor: HexColor("#FFD24A"),
                        child: Image(
                          image: AssetImage("image/image38.png"),
                          color: Colors.white,
                        )),
                    Padding(
                      padding: const EdgeInsets.only(left: 15),
          ...
          child: Padding(
            ...
            child: CircleAvatar(
              ...
              child: FloatingActionButton(
                backgroundColor: HexColor('#FFD24A'),
                child: Image(
                  image: AssetImage('image/image12.png'),
                ),
                mini: true,
                onPressed: () {
                  setState(() {
